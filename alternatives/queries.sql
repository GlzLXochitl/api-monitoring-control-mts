...
(16, 5),
(16, 6),
-- Asignación de usuarios operacionales a proyectos activos
(17, 1),  -- Usuario 17, Proyecto 1
(18, 1),  -- Usuario 18, Proyecto 1
(19, 2),  -- Usuario 19, Proyecto 2
(20, 2),  -- Usuario 20, Proyecto 2
(21, 4),  -- Usuario 21, Proyecto 4
(22, 4),  -- Usuario 22, Proyecto 4
(23, 5),  -- Usuario 23, Proyecto 5
(24, 5);  -- Usuario 24, Proyecto 5
...
-- Items para Ensamble 1 del Proyecto 1
...
-- Items para Ensamble 2 del Proyecto 1
...
-- Items para Ensamble 3 del Proyecto 1
...
-- Items para Ensamble 1 del Proyecto 2
...
-- Items para Ensamble 2 del Proyecto 2
...
-- Items para Ensamble 3 del Proyecto 2
...
-- Items para Ensamble 1 del Proyecto 3
...
-- Items para Ensamble 2 del Proyecto 3
...
-- Items para Ensamble 3 del Proyecto 3
...
-- Items para Ensamble 1 del Proyecto 4
...
-- Items para Ensamble 2 del Proyecto 4
...
-- Items para Ensamble 3 del Proyecto 4
...
-- Items para Ensamble 1 del Proyecto 5
...
-- Items para Ensamble 2 del Proyecto 5
...
-- Items para Ensamble 3 del Proyecto 5
...
-- Items para Ensamble 1 del Proyecto 6
...
-- Items para Ensamble 2 del Proyecto 6
...
-- Items para Ensamble 3 del Proyecto 6
...
-- Insertar datos en la tabla `bom`  --
INSERT INTO `MMC`.`bom` (`project_id`, `item_id`) VALUES
-- Proyecto 1
(1, 1),  -- Item 1 del ensamble 1 para el Proyecto 1
(1, 2),  -- Item 2 del ensamble 1 para el Proyecto 1
(1, 3),  -- Item 3 del ensamble 1 para el Proyecto 1
(1, 4),  -- Item 4 del ensamble 1 para el Proyecto 1
(1, 5),  -- Item 5 del ensamble 1 para el Proyecto 1

(1, 6),  -- Item 1 del ensamble 2 para el Proyecto 1
(1, 7),  -- Item 2 del ensamble 2 para el Proyecto 1
(1, 8),  -- Item 3 del ensamble 2 para el Proyecto 1
(1, 9),  -- Item 4 del ensamble 2 para el Proyecto 1
(1, 10),  -- Item 5 del ensamble 2 para el Proyecto 1

(1, 11),  -- Item 1 del ensamble 3 para el Proyecto 1
(1, 12),  -- Item 2 del ensamble 3 para el Proyecto 1
(1, 13),  -- Item 3 del ensamble 3 para el Proyecto 1
(1, 14),  -- Item 4 del ensamble 3 para el Proyecto 1
(1, 15),  -- Item 5 del ensamble 3 para el Proyecto 1

-- Proyecto 2
(2, 16),  -- Item 1 del ensamble 1 para el Proyecto 2
(2, 17),  -- Item 2 del ensamble 1 para el Proyecto 2
(2, 18),  -- Item 3 del ensamble 1 para el Proyecto 2
(2, 19),  -- Item 4 del ensamble 1 para el Proyecto 2
(2, 20),  -- Item 5 del ensamble 1 para el Proyecto 2

(2, 21),  -- Item 1 del ensamble 2 para el Proyecto 2
(2, 22),  -- Item 2 del ensamble 2 para el Proyecto 2
(2, 23),  -- Item 3 del ensamble 2 para el Proyecto 2
(2, 24),  -- Item 4 del ensamble 2 para el Proyecto 2
(2, 25),  -- Item 5 del ensamble 2 para el Proyecto 2

(2, 26),  -- Item 1 del ensamble 3 para el Proyecto 2
(2, 27),  -- Item 2 del ensamble 3 para el Proyecto 2
(2, 28),  -- Item 3 del ensamble 3 para el Proyecto 2
(2, 29),  -- Item 4 del ensamble 3 para el Proyecto 2
(2, 30),  -- Item 5 del ensamble 3 para el Proyecto 2

-- Proyecto 3
(3, 31),  -- Item 1 del ensamble 1 para el Proyecto 3
(3, 32),  -- Item 2 del ensamble 1 para el Proyecto 3
(3, 33),  -- Item 3 del ensamble 1 para el Proyecto 3
(3, 34),  -- Item 4 del ensamble 1 para el Proyecto 3
(3, 35),  -- Item 5 del ensamble 1 para el Proyecto 3

(3, 36),  -- Item 1 del ensamble 2 para el Proyecto 3
(3, 37),  -- Item 2 del ensamble 2 para el Proyecto 3
(3, 38),  -- Item 3 del ensamble 2 para el Proyecto 3
(3, 39),  -- Item 4 del ensamble 2 para el Proyecto 3
(3, 40),  -- Item 5 del ensamble 2 para el Proyecto 3

(3, 41),  -- Item 1 del ensamble 3 para el Proyecto 3
(3, 42),  -- Item 2 del ensamble 3 para el Proyecto 3
(3, 43),  -- Item 3 del ensamble 3 para el Proyecto 3
(3, 44),  -- Item 4 del ensamble 3 para el Proyecto 3
(3, 45),  -- Item 5 del ensamble 3 para el Proyecto 3

-- Proyecto 4
(4, 46),  -- Item 1 del ensamble 1 para el Proyecto 4
(4, 47),  -- Item 2 del ensamble 1 para el Proyecto 4
(4, 48),  -- Item 3 del ensamble 1 para el Proyecto 4
(4, 49),  -- Item 4 del ensamble 1 para el Proyecto 4
(4, 50),  -- Item 5 del ensamble 1 para el Proyecto 4

(4, 51),  -- Item 1 del ensamble 2 para el Proyecto 4
(4, 52),  -- Item 2 del ensamble 2 para el Proyecto 4
(4, 53),  -- Item 3 del ensamble 2 para el Proyecto 4
(4, 54),  -- Item 4 del ensamble 2 para el Proyecto 4
(4, 55),  -- Item 5 del ensamble 2 para el Proyecto 4

(4, 56),  -- Item 1 del ensamble 3 para el Proyecto 4
(4, 57),  -- Item 2 del ensamble 3 para el Proyecto 4
(4, 58),  -- Item 3 del ensamble 3 para el Proyecto 4
(4, 59),  -- Item 4 del ensamble 3 para el Proyecto 4
(4, 60),  -- Item 5 del ensamble 3 para el Proyecto 4

-- Proyecto 5
(5, 61),  -- Item 1 del ensamble 1 para el Proyecto 5
(5, 62),  -- Item 2 del ensamble 1 para el Proyecto 5
(5, 63),  -- Item 3 del ensamble 1 para el Proyecto 5
(5, 64),  -- Item 4 del ensamble 1 para el Proyecto 5
(5, 65),  -- Item 5 del ensamble 1 para el Proyecto 5

(5, 66),  -- Item 1 del ensamble 2 para el Proyecto 5
(5, 67),  -- Item 2 del ensamble 2 para el Proyecto 5
(5, 68),  -- Item 3 del ensamble 2 para el Proyecto 5
(5, 69),  -- Item 4 del ensamble 2 para el Proyecto 5
(5, 70),  -- Item 5 del ensamble 2 para el Proyecto 5

(5, 71),  -- Item 1 del ensamble 3 para el Proyecto 5
(5, 72),  -- Item 2 del ensamble 3 para el Proyecto 5
(5, 73),  -- Item 3 del ensamble 3 para el Proyecto 5
(5, 74),  -- Item 4 del ensamble 3 para el Proyecto 5
(5, 75),  -- Item 5 del ensamble 3 para el Proyecto 5

-- Proyecto 6
(6, 76),  -- Item 1 del ensamble 1 para el Proyecto 6
(6, 77),  -- Item 2 del ensamble 1 para el Proyecto 6
(6, 78),  -- Item 3 del ensamble 1 para el Proyecto 6
(6, 79),  -- Item 4 del ensamble 1 para el Proyecto 6
(6, 80),  -- Item 5 del ensamble 1 para el Proyecto 6

(6, 81),  -- Item 1 del ensamble 2 para el Proyecto 6
(6, 82),  -- Item 2 del ensamble 2 para el Proyecto 6
(6, 83),  -- Item 3 del ensamble 2 para el Proyecto 6
(6, 84),  -- Item 4 del ensamble 2 para el Proyecto 6
(6, 85),  -- Item 5 del ensamble 2 para el Proyecto 6

(6, 86),  -- Item 1 del ensamble 3 para el Proyecto 6
(6, 87),  -- Item 2 del ensamble 3 para el Proyecto 6
(6, 88),  -- Item 3 del ensamble 3 para el Proyecto 6
(6, 89),  -- Item 4 del ensamble 3 para el Proyecto 6
(6, 90);  -- Item 5 del ensamble 3 para el Proyecto 6
