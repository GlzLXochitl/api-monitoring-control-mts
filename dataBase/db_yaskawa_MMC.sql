...
CREATE TABLE IF NOT EXISTS `mmc`.`items` (
  ...
  `assembly_id` INT UNSIGNED NULL DEFAULT NULL,
  `subassembly_id` INT UNSIGNED NULL DEFAULT NULL,
  ...
  `in_subassembly` TINYINT NULL DEFAULT NULL,
  `number_material` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `mmc`.`bom` (
  ...
  `stock_items_id` INT UNSIGNED NULL DEFAULT NULL,
  `created_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `id_UNIQUE` (`id` ASC) VISIBLE,
